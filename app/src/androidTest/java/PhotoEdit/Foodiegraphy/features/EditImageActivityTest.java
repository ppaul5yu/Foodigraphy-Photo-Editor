package PhotoEdit.Foodiegraphy.features;
...
import PhotoEdit.Foodiegraphy.features.tools.EditImageActivity;
...
public class EditImageActivityTest {
    ...
    public void checkIfActivityIsLaunched() {
        onView(ViewMatchers.withText("Foodiegraphy")).check(matches(isDisplayed()));
    }
}