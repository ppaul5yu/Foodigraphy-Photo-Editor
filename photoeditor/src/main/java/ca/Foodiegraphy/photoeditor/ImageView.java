...
import ca.Foodiegraphy.features.PhotoFilter;

import static android.media.effect.EffectFactory.*;
import static ca.Foodiegraphy.features.PhotoFilter.*;


class ImageView extends GLSurfaceView implements GLSurfaceView.Renderer {
